...
# Paths
image_path = '../GenAI_images/one_phase/00002.png'
output_folder_path = '../GenAI_images/one_phase/00002'
binary_image_path = os.path.join(output_folder_path, '../binary/00002.png')
